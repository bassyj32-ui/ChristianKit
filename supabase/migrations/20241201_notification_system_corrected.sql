-- Corrected Notification System Migration
-- This works with existing user_profiles table that uses 'id' as primary key
...
-- ================================================================
-- These queries will help verify the setup worked correctly
...
-- Check that user_profiles has experience_level column
SELECT 
  column_name,
  CASE WHEN column_name = 'experience_level' THEN '✅ Added' ELSE '❌ Missing' END as status
