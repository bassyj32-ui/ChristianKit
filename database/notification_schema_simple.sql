-- Simplified Notification System Database Schema for ChristianKit
-- This version doesn't depend on Supabase auth.users
...
CREATE TABLE IF NOT EXISTS scheduled_notifications (
  ...
  title TEXT NOT NULL,
  body TEXT NOT NULL,
  type TEXT NOT NULL CHECK (type IN ('prayer', 'bible', 'meditation', 'journal', 'reminder', 'achievement')),
  data JSON DEFAULT '{}',
...
INSERT INTO notification_templates (name, title, body, type, variables) VALUES
