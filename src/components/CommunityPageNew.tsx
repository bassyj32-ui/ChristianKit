...
const CommunityPage = () => {
  ...
  const filteredPosts = posts.filter(post => {
    const { contentFilter } = useCommunityStore.getState()
    if (contentFilter === 'all') return true
    return post.category === contentFilter
  })
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="sticky top-0 z-10 bg-black/80 backdrop-blur-xl border-b border-gray-800">
        <div className="max-w-2xl mx-auto">
          <div className="p-4">
            <OsmoSectionHeader className="text-center">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {/* Error Display */}
        {error && (
          <div className="bg-red-900/20 border border-red-500/20 rounded-lg p-4 m-4">
        ...
        {hasMorePosts && !isLoading && filteredPosts.length > 0 && (
          <div className="p-4 text-center">
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-400 text-black px-6 py-2 rounded-full font-bold transition-colors duration-200 disabled:opacity-50"
            >
              {isLoadingMore ? (
